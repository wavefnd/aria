 ...
 *
 * AriaJDK JNI declarations.
 *
 * This header is authored for AriaJDK and tracks the Java SE JNI ABI
 * surface required for Java 17 compatibility.
 */
...
struct JNIEnv_ {
    ...
    void DeleteGlobalRef(jobject ref) { functions->DeleteGlobalRef(this, ref); }
    void DeleteLocalRef(jobject ref) { functions->DeleteLocalRef(this, ref); }
...
#define ARIA_JNI_API JNIEXPORT
#else
#define ARIA_JNI_API JNIIMPORT
#endif

ARIA_JNI_API jint JNICALL JNI_GetDefaultJavaVMInitArgs(void* args);
ARIA_JNI_API jint JNICALL JNI_CreateJavaVM(JavaVM** pvm, void** penv, void* args);
ARIA_JNI_API jint JNICALL JNI_GetCreatedJavaVMs(JavaVM** vmBuf, jsize bufLen, jsize* nVMs);
